...
![Screen recording showing 3 toast messages popping up from user input](./src/assets/toast-demo.gif)

## Getting Started (New)

This project is created with [Vitel](https://parceljs.org/). It's intended to be run locally, on your computer, using Node.js and NPM.
...
![Image showing a textarea and set of radio buttons, along with a “Pop Toast!” radio button](./src/assets/playground.png)
...
![Screen recording showing how a demo Toast component can be edited using the playground](./src/assets/toast-exercise-2-demo.gif)
...
![Several toasts popping up, one after another](./src/assets/poppin-toasts.gif)
...
![Screen recording showing toast messages popping up when “Pop Toast!” is clicked](./src/assets/toast-exercise-3-demo.gif)
